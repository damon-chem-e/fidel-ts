...
- My datasets
-- GDELT (full news 15 min increments + US equities 15 minutes + crypto 15 min + macro series fred + oil + FX), GDELT ingests news, parses it to what happened in structured form, but does not redistribute originals. still very valuable I think for world events effects on markets. Very rich data (lower frequency)
