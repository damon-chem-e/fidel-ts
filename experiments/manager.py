...
class ExperimentManager:
    ...
    def save_checkpoint(self, checkpoint: Dict[str, Any], filename: str = "checkpoint.pth") -> Path:
        """
    ...
    def save_visualization(self, fig, filename: str) -> Path:
        """
